...
Student **Politechniki Śląskiej** (**Informatyka Przemysłowa**) — tworzę aplikacje w **.NET (C#)** oraz frontend w **React**.

- **📍 Lokalizacja:** Katowice / Remote
- **💼 Profil:** .NET / Full‑stack (bez różnicy)
- **🔗 Kontakt:** LinkedIn: https://www.linkedin.com/in/mikolajskaziak
- **🐾 Fun fact:** mam kota — Zofię
...
- **🟨 JavaScript**
- **⚛️ React**
- **🗄️ Bazy danych:** PostgreSQL, SQL Server
- **🐳 Docker**
- **☁️ Azure**
